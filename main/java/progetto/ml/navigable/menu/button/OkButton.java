...
public class OkButton extends GameButton
{
	...
	private static Text TEXT = new Text("Ok", Style.BOLD, 12.0f, DEFAULT_TEXT_COLOR);
	private static Text OVER_TEXT = new Text("Ok", Style.BOLD, 12.0f, DEFAULT_OVER_TEXT_COLOR);
